# [Archiv8][a8]![External Link][ext-link_h1] LICENSE
...
[Readme](README.md) || [Install](INSTALL.md) || [Issues](ISSUES.md) || ![Page Indicator][nav-r-em][Licensing](LICENSE.md)![Page Indicator][nav-l-em] || [How to help](HOW-TO-HELP.md) || [Changelog](CHANGELOG.md) || [Commitlog](COMMITLOG.md)

[MIT](MIT.md) || [CC-BY-SA](CC-BY-SA-V4.md)
...
Original code produced for [Archiv8][a8] is released under the [MIT](_MIT.md_) license unless otherwise stated.
...
[![Creative Commons Attribution-ShareAlike 4.0 International License][cc-badge]][cc-terms]

Documentation is licensed using the [_Creative Commons Attribution-ShareAlike 4.0 International License_](CC-BY-SA-V4.md)

### Attribution

Should there be an error or confusion in the attribution of: upstream sources or external documentation please create an issue for [this repository][a8-repo-issue]. A correction will be made as soon as possible.
