...
This repository contains the packaging components to build [the package][upstream-url] for [Arch Linux][arch-url].
...
[![Conventional Commits, version 1.0.0, adopted][commits-badge]]Original code produced for [Archiv8][a8-url] is released under the [MIT](_MIT.md_) license unless otherwise stated. [![Keep a Changelog, version 1.0.0, adopted][changelog-badge]][change-url] [![Semantic Versioning, version 2.0.0, adopted][semver-badge]][semver-url]
...
[a8-repo-url]: https://github.com/Archiv8/archiv8-io-theme
