...
---
[Readme](README.md) || ![Page Indicator][nav-r-em][Install](INSTALL.md)![Page Indicator][nav-l-em] || [Issues](ISSUES.md) || (COMMUNITY.md) || [How to help](HOW-TO-HELP.md) || [Change Log](CHANGELOG.md)
...
There are no dependencies for [PkgBrowser][ups-pkg]![External Link][ext-link] that need to be made available prior to building and installing this package. Download the [latest release][a8-pkg-src] containing the PKGBUILD and associated files.

## Installation

Installation should should follow one of the methods described in the [ArchWiki][arch-wiki]![External Link][ext-link].  If you are building many Archiv8 / AUR packages creating and using a [custom local repository][arch-wiki-local-repo]![External Link][ext-link] will help speed up the process.
